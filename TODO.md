...
- [x] **Document stage changes in ARCHITECTURE.md** — stage enforcement section added with table of checks — PR #41
...
- [x] **Enforce structured findings format** — `mc briefing generate` now warns when findings lack Summary header — PR #41
- [x] **mc-core graceful fallback** — was actually a gates.json format mismatch, fixed by compat loader in PR #40

## Process

- [x] **Hard stop at every gate** — documented in SKILL.md rule #9 + CLAUDE.md, code-enforced via velocity check — PR #41
